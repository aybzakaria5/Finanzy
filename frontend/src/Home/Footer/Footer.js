...
import Style from './Footer.module.css'; // Import the CSS file for styling
    ...
    <footer className={Style.footer}>
      <ul className={Style.social_links}>
        <li className={Style.item_content}>
          ...
          <div className={Style.tooltip}>zawolf_0</div>
        </li>
        <li className={Style.item_content}>
          ...
          <div className={Style.tooltip}>Finanzy</div>
        </li>
        <li className={Style.item_content}>
          ...
          <div className={Style.tooltip}>aybzakaria5</div>
        </li>
        <li className={Style.item_content}>
      ...
      <div className={Style.contact_info}>
        <p>Email: info@finanzy.com</p>
        <p>Phone: +123 456 7890</p>
      </div>
      <div className={Style.copyright}>
        &copy; {new Date().getFullYear()} Finanzy. All rights reserved.
      </div>
    </footer>
  );
};
